            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" row items-center justify-content-between">
                        <h1 class="h3 mb-2 text-gray-800"> <i class="fa fa-archive ml-3 mr-2"></i>Data Hasil AKhir
                        </h1>
                        <div class=" mr-2">
                            <a href="/pembobotan" class="btn btn-primary btn-icon-split">
                                <span class="text"><i class="fa fa-print mr-2 pt-1" aria-hidden="true"></i>
                                    Cetak Data</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4 mt-4">
                        <div class="card-header py-3">
                            <div class=" row justify-content-between align-items-center px-3">
                                <h6 class="m-0 font-weight-bold text-success">Hasil Akhir Perangkingan</h6>
                            </div>
                        </div>
                        <div class="card-body">
