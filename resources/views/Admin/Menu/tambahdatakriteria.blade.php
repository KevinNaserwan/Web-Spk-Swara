            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="/postdatakriteria" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class=" row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" id="namakriteria" name="nama"
                                            placeholder="Masukkan Nama Kriteria">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="bobotawal" class=" font-weight-bolder">Bobot Kriteria Awal</label>
                                        <input type="float" class="form-control" id="bobotawal" name="bobot"
                                ...
                                <button type="submit" class="btn btn-success btn-icon-split mr-3">
                                    <span class="text"><i class="fa fa-plus mr-2 pt-1" aria-hidden="true"></i>
                                        Simpan</span>
                                </button><button href="#" class="btn btn-primary btn-icon-split">
