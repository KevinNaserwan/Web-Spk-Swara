            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class=" row items-center justify-content-between mb-4">
                        ...
                        <div class=" mr-2">
                            <a href="/dataalternatif" class="btn btn-secondary btn-icon-split">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-plus mr-2 pt-1"
                                    aria-hidden="true"></i>Tambah Data Alternatif</h6>
                        </div>
                        <div class="card-body">
                            <form action="/postdataalter" method="POST" enctype="multipart/form-data">
                                @csrf
                                <label for="nama_alternatif" class=" font-weight-bolder">Nama Alternatif</label>
                                <input type="text" class="form-control" id="nama_alternatif"
                                    name="nama_alternatif" placeholder="Masukkan Nama Alternatif">
                                    <div class=" mt-4">
