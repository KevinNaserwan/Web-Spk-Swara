    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav
                    class=" justify-content-end navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><i class="fa fa-home" aria-hidden="true"></i>
                            Dashboard</h1>
                    </div>

                    <div class="alert alert-success" role="alert">
                        Selamat Datang <span class="font-weight-bolder">ADMIN!</span> Anda bisa mengakses sistem dengan wewenang tertentu melalui pilihan menu dibawah
                      </div>
